...
// On affiche tout l'objet dont le nom est Emma, donc le 2e element du tableau : 
console.log(users[1])
...
// Splice sert à supprimer ou à remplacer des éléments d'un tableaux :

// Le premier nombre est l'indice de l'élément à supprimer (2), 
// Le deuxième est le nombre d'élément à supprimer (1)
library.splice(2, 1) // Supprime un élément depuis l'indice 2
